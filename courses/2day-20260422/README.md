# Training materials from the 2-day intro course, April 2026
...
-   `proces-slides-*.sh`: Change the names of the exported slides (PNG 1920x1080) 
    in `public/2day-20260422/img/LUMI-2day-20260422-*` from `DiaXX.png` to the names
    used in the notes markdown document.

-   `video-2day-20260422.sh`: Get the videos from the video processing directory on my local
