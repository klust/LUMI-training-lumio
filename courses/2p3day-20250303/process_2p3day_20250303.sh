...
copy_to_repo private "$SLIDES/HPE/11_1_Python_Frameworks.pdf"                            "LUMI-$training-501-Introduction_to_Python_on_Cray_EX.pdf"
copy_to_repo private "$SLIDES/HPE/12_IO_medium_LUMI.pdf"                                 "LUMI-$training-503-IO_Optimization_Parallel_IO.pdf"
...
copy_to_repo public "$SLIDES/AMD/session 05 - omniperf.pdf"                              "LUMI-$training-504-AMD_Omniperf.pdf"
copy_to_repo public "$SLIDES/AMD/session 06 - ToolsInActionPytorchExample-LUMI-2024.pdf" "LUMI-$training-505-Best_Practices_GPU_Optimization.pdf"

# Files that are generated by this script
copy_to_repo public "$SLIDES/AMD/session-6-scripts.tar"                                  "LUMI-$training-505-scripts.tar"
copy_to_repo public "$SLIDES/AMD/session-6-scripts.tar.bz2"                              "LUMI-$training-505-scripts.tar.bz2"
