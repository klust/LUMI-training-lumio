...
copy_to_repo private "$SLIDES/HPE/08_debugging_at_scale.pdf"                             "LUMI-$training-306-Debugging_at_Scale.pdf"
copy_to_repo private "$SLIDES/HPE/09_introduction_to_perftools.pdf"                      "LUMI-$training-401-Introduction_to_Perftools.pdf"
copy_to_repo private "$SLIDES/HPE/10_advanced_performance_analysis_merged.pdf"           "LUMI-$training-402-Advanced_Performance_Analysis.pdf"
copy_to_repo private "$SLIDES/HPE/13_cpu_performance_optimization.pdf"                   "LUMI-$training-403-Performance_Optimization_Improving_Single_Core.pdf"
...
copy_to_repo private "$SLIDES/HPE/12_2_GPU_porting.pdf"                                  "LUMI-$training-502-Porting_to_GPU.pdf"
...
copy_to_repo public "$SLIDES/AMD/session 06 - ToolsInActionPytorchExample-LUMI-2024.pdf" "LUMI-$training-506-Best_Practices_GPU_Optimization.pdf"
