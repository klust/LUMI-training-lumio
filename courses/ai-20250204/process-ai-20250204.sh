...
copy_to_repo public "06_Bulding_containers_from_conda_pip_environments/Building_containers_from_conda_pip_environments.pdf" "LUMI-$training-06-Building_containers_from_conda_pip_environments.pdf"
