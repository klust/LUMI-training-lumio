...
copy_to_repo private "$SLIDES/HPE/02_Compilers_SingleCoreOpt.pdf"               "LUMI-$training-1_02_Compilers_SingleCoreOpt.pdf"
...
copy_to_repo public "$SLIDES/AMD/session 01a - HIP and ROCm.pdf"               "LUMI-$training-2_01_HIP-and-ROCm.pdf"
copy_to_repo public "$SLIDES/AMD/session 02 - introduction to rocprof.pdf"     "LUMI-$training-2_01_introduction-to-rocprof.pdf"
copy_to_repo public "$SLIDES/AMD/session 03 - omnitrace.pdf"                   "LUMI-$training-2_02_omnitrace.pdf"
copy_to_repo public "$SLIDES/AMD/session 04 - omniperf.pdf"                    "LUMI-$training-2_02_omiperf.pdf"
copy_to_repo public "$SLIDES/AMD/session 05 - ToolsInActionPytorchExample.pdf" "LUMI-$training-3_01-Best_Practices_GPU_Optimization.pdf"
