...
then
    ...
    mkdir -p $SLIDES/AMD
    pushd $EXERCISES/AMD
    demo_scripts="session-5-scripts"
...
#copy_to_repo public  "$SLIDES/HPE/Exercises.pdf"                                "LUMI-$training-Exercises_HPE.pdf"
...
copy_to_repo private "$SLIDES/HPE/02_Compilers.pdf"                             "LUMI-$training-1_02_Compilers_Libraries.pdf"
copy_to_repo private "$SLIDES/HPE/03_introduction_to_perftools.pdf"             "LUMI-$training-1_03_introduction_to_perftools.pdf"
copy_to_repo private "$SLIDES/HPE/04_advanced_performance_analysis_merged.pdf"  "LUMI-$training-1_04_advanced_performance_analysis.pdf"
copy_to_repo private "$SLIDES/HPE/05_demo.pdf"                                  "LUMI-$training-1_05_DemoOptimizingCode.pdf"
copy_to_repo private "$SLIDES/HPE/06_cray_mpi_short.pdf"                        "LUMI-$training-2_01_cray_mpi.pdf"
copy_to_repo private "$SLIDES/HPE/07_IO_short_LUMI.pdf"                         "LUMI-$training-2_02_IO_LUMI.pdf"
...
copy_to_repo public "$SLIDES/AMD/session 01 - HIP and ROCm.pdf"                "LUMI-$training-2_01_HIP-and-ROCm.pdf"
copy_to_repo public "$SLIDES/AMD/session 02 - introduction to rocprof.pdf"     "LUMI-$training-2_01_introduction-to-rocprof.pdf"
copy_to_repo public "$SLIDES/AMD/session 03 - rocprof-sys.pdf"                 "LUMI-$training-2_02_rocprof-sys.pdf"
copy_to_repo public "$SLIDES/AMD/session 04 - rocprof-compute.pdf"             "LUMI-$training-2_02_rocprof-compute.pdf"
copy_to_repo public "$SLIDES/AMD/session 05 - ToolsInActionPytorchExample.pdf" "LUMI-$training-3_01_Best_Practices_GPU_Optimization.pdf"

# Files that are generated by this script
copy_to_repo public "$SLIDES/AMD/session-5-scripts.tar"                     "LUMI-$training-3_01-scripts.tar"
copy_to_repo public "$SLIDES/AMD/session-5-scripts.tar.bz2"                 "LUMI-$training-3_01-scripts.tar.bz2"
